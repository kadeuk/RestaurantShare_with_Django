...
def Update_restaurant(request):
    ...
    before_reataurant = Restaurant.objects.get(id = resId)
    before_reataurant.category = change_category
    before_reataurant.restaurant_name = change_name
    before_reataurant.restaurant_link = change_link
    before_reataurant.restaurant_content = change_content
    before_reataurant.restaurant_keyword = change_keyword
    before_reataurant.save()
